  ...
  return (
    <div className="h-full overflow-y-auto px-4 pb-[calc(var(--ec-dock-h)+var(--ec-safe-b)+24px)]">
      <header className="flex items-baseline gap-3 pt-4">
        <h1 className="font-display text-[19px] font-semibold">Marketplace</h1>
      ...
      <div className="mt-6 rounded-panel border border-dashed border-[var(--ec-violet)]/30 px-5 py-11 text-center">
        <p className="mx-auto max-w-[34ch] text-[13.5px] font-light text-dim">Listings trace back through the asset graph, so credit and splits are computed rather than negotiated.</p>
        <p className="mt-4 font-mono text-[9px] uppercase tracking-[.2em] text-cyan">Ships in M6</p>
      </div>
    </div>
  );
}
